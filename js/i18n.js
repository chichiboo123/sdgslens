...
const I18N = {
  ko: {
    ...
    life: {
      heading: '위 문제 상황에 대한 나의 생각을 적어봅시다.',
      placeholder: '예) 우리가 물을 아껴 쓰면 물이 부족한 친구들에게도 도움이 될 수 있어요...',
      prompts: [
        '우리가 매일 쓰는 물건 중에는 ',
        '우리 학교에서는 이 문제를 줄이기 위해 ',
        '나는 이 문제를 위해 오늘부터 ',
        '한국에서도 비슷하게 ',
        '우리 동네에서 볼 수 있는 모습은 ',
        '친구들과 함께 할 수 있는 일은 ',
    ...
    help: {
      ...
      steps: [
        ...
        '<b>위 문제 상황에 대한 나의 생각</b>을 한두 문장 적어봐요.',
    ...
    sdgLabels: ['빈곤 퇴치','기아 종식','건강과 복지','양질의 교육','성평등','깨끗한 물','청정 에너지','양질의 일자리','산업과 혁신','불평등 감소','지속가능 도시','책임 있는 소비','기후 행동','해양 생태계','육상 생태계','평화와 정의','글로벌 파트너십'],
  },
  en: {
    htmlLang: 'en',
    brand: {
    ...
    export: {
      title: 'Export my exploration',
      savePng: 'Save PNG',
      copyPng: 'Copy PNG',
      copied: 'PNG copied to clipboard.',
      copyUnsupported: 'PNG clipboard copy is not supported in this browser. Please use Save PNG.',
  ...
  ja: {
    ...
    export: {
      ...
      savePng: 'PNG保存',
      copyPng: 'PNGコピー',
      copied: 'PNG画像をクリップボードにコピーしました。',
      copyUnsupported: 'このブラウザではPNGのクリップボードコピーに対応していません。PNG保存を使ってください。',
      failed: '書き出しに失敗しました。もう一度試してください。',
    },
    sdg: {
